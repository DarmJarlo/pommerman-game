...
Source: https://github.com/BorealisAI/pommerman-baseline
"""
import os
import sys
...
def _compute_safe_actions(obs, exclude_kicking=False, prev_two_obs=(None,None)):
    ...
    for direction in dirs:
        ...
        gone_flame_pos=None
        if (prev_two_obs != None and prev_two_obs[0]!=None and prev_two_obs[1]!=None) and _check_if_flame_will_gone(obs, prev_two_obs, position):
